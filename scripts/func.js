...
function updateStats() {
    ...
    document.getElementById('energy').textContent = Math.max(0, Math.floor(energy));
    document.getElementById('food').textContent = Math.max(0, Math.floor(food));
    document.getElementById('population').textContent = Math.max(0, Math.floor(population));
    ...
    if (document.getElementById('researchPoint')) {
        document.getElementById('researchPoint').textContent = Math.floor(researchPoint);
    }
